...
<template>
  ...
  >
    ...
    <div class="mt-4 px-3">
      <div
        v-if="!isCollapsed"
        class="flex items-center justify-between text-xs font-medium text-gray-500 mb-2 px-2"
      >
        <span>分组</span>
      ...
      <div class="space-y-0.5">
        ...
        >
          ...
          <Pin
            v-if="group.pinned && !isCollapsed"
            class="w-3 h-3 text-gray-500 rotate-45 flex-shrink-0"
          />
        </button>
      </div>
    </div>
    ...
    <div class="p-3 border-t border-gray-800 mt-auto">
      ...
      <a-dropdown :trigger="['click']" overlayClassName="custom-dropdown" placement="topLeft">
        <button
          v-if="isLoggedIn"
          class="w-full flex items-center gap-3 px-2 py-2 rounded-lg hover:bg-[#2b2b2b] transition-colors group"
        ...
        <template #overlay>
          ...
          >
            ...
            <div class="px-2 py-1">
              ...
              <a-menu-item
                key="logout"
                class="text-gray-200 hover:bg-[#3f3f3f] rounded-lg !p-0 mt-1"
              >
                <div class="flex items-center gap-3 px-3 py-2">
    ...
    <!-- Login Modal -->
    <LoginModal v-model:open="showLoginModal" @login="handleLogin" @register="handleRegister" />
  </div>
</template>
