    ...
    <div class="max-w-6xl mx-auto">
      ...
      <div class="flex items-center gap-6 mb-12">
        <div class="w-24 h-24 rounded-full bg-blue-600 overflow-hidden ring-4 ring-[#1e1e1e]">
          <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=zm41" alt="Avatar" class="w-full h-full object-cover" />
        </div>
        <div>
          <h1 class="text-3xl font-bold text-white mb-2">用户zm41</h1>
          <div class="flex items-center gap-4">
            <p class="text-gray-400">与元宝共度 889 天</p>
            <button class="px-3 py-1 border border-gray-700 rounded-full text-xs text-gray-400 hover:text-white hover:border-gray-500 hover:bg-[#2b2b2b] transition-all">
              编辑资料
            </button>
          </div>
        </div>
              ...
              <div class="flex items-start gap-3">
                ...
                <div class="flex-1 min-w-0">
                  <div class="flex justify-between items-start">
                    <h4 class="text-gray-200 font-medium truncate pr-2 group-hover:text-white transition-colors">{{ file.title }}</h4>
